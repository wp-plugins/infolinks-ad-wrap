...
== Description ==
We can explicitly control what parts of our sites to display infolinks's In-Text Advertising by using ON/OFF options as follows.

By default, if no tags are implemented, the Infolinks will appear in all appropriate sections. 

However if you want to restrict the In-Text ads to specific sections use the tags below:
